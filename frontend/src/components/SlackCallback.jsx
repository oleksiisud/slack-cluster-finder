...
import { handleSlackCallback } from '../services/slackAuth';
  ...
  useEffect(() => {
    const processCallback = async () => {
      ...
      try {
        ...
        setStatus('Success! Slack connected.');
        setTimeout(() => navigate('/new-dashboard'), 2000);
      } catch (err) {
        setError(err.message || 'Failed to complete Slack authorization');
        setTimeout(() => navigate('/new-dashboard'), 3000);
      }
    };
